...
/**
 * This is the item provider adapter for a {@link uidiagrampart.TableColumn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableColumnItemProvider extends PropertiesElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableColumn_uniqueID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableColumn_uniqueID_feature", "_UI_TableColumn_type"),
				 UidiagrampartPackage.Literals.TABLE_COLUMN__UNIQUE_ID,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TableColumn.class)) {
			case UidiagrampartPackage.TABLE_COLUMN__UNIQUE_ID:
