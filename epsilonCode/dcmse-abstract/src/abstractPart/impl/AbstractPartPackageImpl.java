...
public class AbstractPartPackageImpl extends EPackageImpl implements AbstractPartPackage {
	 ...
	 * @generated
	 */
	public EReference getAssociationsMSE_LstRelations() {
		return (EReference)associationsMSEEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getAssociationsMSE_LstInheritance() {
		return (EReference)associationsMSEEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(associationsMSEEClass, ASSOCIATIONS_MSE__LST_RELATIONS);
	...
	public void initializePackageContents() {
		...
		initEReference(getPackageMSE_Associations(), this.getAssociationsMSE(), null, "associations", null, 0, 1, PackageMSE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClassMSE_Identifier(), this.getHashCodeClassMSE(), null, "identifier", null, 0, 1, ClassMSE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssociationsMSE_LstRelations(), this.getRelationMSE(), null, "lstRelations", null, 0, -1, AssociationsMSE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
