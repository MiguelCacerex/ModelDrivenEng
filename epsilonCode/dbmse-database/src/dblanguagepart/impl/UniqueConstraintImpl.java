 ...
 * </p>
 * <ul>
 *   <li>{@link dblanguagepart.impl.UniqueConstraintImpl#getType <em>Type</em>}</li>
 *   <li>{@link dblanguagepart.impl.UniqueConstraintImpl#getNameConstraint <em>Name Constraint</em>}</li>
 *   <li>{@link dblanguagepart.impl.UniqueConstraintImpl#getColumnConstraint <em>Column Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniqueConstraintImpl extends EObjectImpl implements UniqueConstraint {
	 ...
	 * @ordered
	 */
	protected static final String TYPE_EDEFAULT = "Unique";
	...
	protected EClass eStaticClass() {
		return DblanguagepartPackage.Literals.UNIQUE_CONSTRAINT;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblanguagepartPackage.UNIQUE_CONSTRAINT__TYPE, oldType, type));
	}
	...
	public void setNameConstraint(String newNameConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblanguagepartPackage.UNIQUE_CONSTRAINT__NAME_CONSTRAINT, oldNameConstraint, nameConstraint));
	}
	...
	public EList<Column> getColumnConstraint() {
		if (columnConstraint == null) {
			columnConstraint = new EObjectResolvingEList<Column>(Column.class, this, DblanguagepartPackage.UNIQUE_CONSTRAINT__COLUMN_CONSTRAINT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DblanguagepartPackage.UNIQUE_CONSTRAINT__COLUMN_CONSTRAINT:
