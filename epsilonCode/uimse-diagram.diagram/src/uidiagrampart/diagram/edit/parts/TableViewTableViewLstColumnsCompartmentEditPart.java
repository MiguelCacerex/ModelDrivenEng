...
import uidiagrampart.diagram.edit.policies.TableViewTableViewLstColumnsCompartmentCanonicalEditPolicy;
import uidiagrampart.diagram.edit.policies.TableViewTableViewLstColumnsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TableViewTableViewLstColumnsCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public TableViewTableViewLstColumnsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.TableViewTableViewLstColumnsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TableViewTableViewLstColumnsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagrampartVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TableViewTableViewLstColumnsCompartmentCanonicalEditPolicy());
	}
