...
import uidiagrampart.diagram.edit.policies.Button2ItemSemanticEditPolicy;
...
public class Button2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName2EditPart) {
			((ButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(ButtonName2EditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 191, 201, 202);
