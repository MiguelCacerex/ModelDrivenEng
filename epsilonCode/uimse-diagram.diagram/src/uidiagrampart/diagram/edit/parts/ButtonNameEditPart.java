 ...
 * @generated
 */
public class ButtonNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.Button_3003, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.ButtonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
