...
import uidiagrampart.diagram.edit.policies.GroupGroupLstGraphicElementCompartment2CanonicalEditPolicy;
import uidiagrampart.diagram.edit.policies.GroupGroupLstGraphicElementCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupLstGraphicElementCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupLstGraphicElementCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupLstGraphicElementCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupLstGraphicElementCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagrampartVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupGroupLstGraphicElementCompartment2CanonicalEditPolicy());
	}
