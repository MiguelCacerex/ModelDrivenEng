...
import uidiagrampart.diagram.edit.policies.TextField2ItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class TextField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TextField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TextField2ItemSemanticEditPolicy());
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new TextFieldFigure();
	}
	...
	*/
	public TextFieldFigure getPrimaryShape() {
		return (TextFieldFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextFieldName2EditPart) {
			((TextFieldName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTextFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(TextFieldName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class TextFieldFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureTextFieldLabelFigure;
		...
		private void createContents() {
			...
			fFigureTextFieldLabelFigure = new WrappingLabel();

			fFigureTextFieldLabelFigure.setText("TextField");

			this.add(fFigureTextFieldLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTextFieldLabelFigure() {
			return fFigureTextFieldLabelFigure;
		}
