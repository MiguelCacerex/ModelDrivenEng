...
import uidiagrampart.diagram.edit.policies.TableView2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TableView2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TableView2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TableView2ItemSemanticEditPolicy());
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableViewName2EditPart) {
			((TableViewName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTableViewLabelFigure());
			return true;
		}
		if (childEditPart instanceof TableViewTableViewLstColumnsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTableViewLstColumnsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TableViewTableViewLstColumnsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableViewTableViewLstColumnsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTableViewLstColumnsCompartmentFigure();
			pane.remove(((TableViewTableViewLstColumnsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TableViewTableViewLstColumnsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(TableViewName2EditPart.VISUAL_ID));
	}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UidiagrampartElementTypes.TableColumn_3011) {
				return getChildBySemanticHint(UidiagrampartVisualIDRegistry
						.getType(TableViewTableViewLstColumnsCompartment2EditPart.VISUAL_ID));
			}
		}
