...
import uidiagrampart.diagram.edit.policies.GroupItemSemanticEditPolicy;
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstGraphicElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstGraphicElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupLstGraphicElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstGraphicElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstGraphicElementCompartmentFigure();
			pane.remove(((GroupGroupLstGraphicElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupLstGraphicElementCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(GroupNameEditPart.VISUAL_ID));
	}
