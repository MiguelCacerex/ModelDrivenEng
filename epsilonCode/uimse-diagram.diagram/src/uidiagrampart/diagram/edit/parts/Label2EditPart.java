...
import uidiagrampart.diagram.edit.policies.Label2ItemSemanticEditPolicy;
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(LabelName2EditPart.VISUAL_ID));
	}
