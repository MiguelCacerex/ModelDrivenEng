...
import uidiagrampart.diagram.edit.policies.ComboBoxItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class ComboBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ComboBoxEditPart(View view) {
		super(view);
	}
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComboBoxNameEditPart) {
			((ComboBoxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureComboBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(ComboBoxNameEditPart.VISUAL_ID));
	}
