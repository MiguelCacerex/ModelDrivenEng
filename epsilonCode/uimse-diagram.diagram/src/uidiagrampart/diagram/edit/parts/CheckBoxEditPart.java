...
import uidiagrampart.diagram.edit.policies.CheckBoxItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class CheckBoxEditPart extends AbstractBorderedShapeEditPart {
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof CheckBoxNameEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(CheckBoxNameEditPart.VISUAL_ID));
	}
