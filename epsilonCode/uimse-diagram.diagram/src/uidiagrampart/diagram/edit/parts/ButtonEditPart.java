...
import uidiagrampart.diagram.edit.policies.ButtonItemSemanticEditPolicy;
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonNameEditPart) {
			((ButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(ButtonNameEditPart.VISUAL_ID));
	}
