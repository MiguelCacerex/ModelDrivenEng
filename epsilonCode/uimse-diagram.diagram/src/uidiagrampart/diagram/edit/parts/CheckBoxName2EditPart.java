...
import uidiagrampart.diagram.edit.policies.UidiagrampartTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CheckBoxName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UidiagrampartVisualIDRegistry.getType(uidiagrampart.diagram.edit.parts.CheckBoxName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CheckBoxName2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new UidiagrampartTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.CheckBox_3014, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.CheckBoxName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, UidiagrampartEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CheckBoxLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CheckBoxLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CheckBoxLabelFigure() {
