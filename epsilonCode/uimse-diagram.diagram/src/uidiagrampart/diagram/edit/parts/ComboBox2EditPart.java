...
import uidiagrampart.diagram.edit.policies.ComboBox2ItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class ComboBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ComboBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComboBox2ItemSemanticEditPolicy());
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new ComboBoxFigure();
	}

	/**
	* @generated
	*/
	public ComboBoxFigure getPrimaryShape() {
		return (ComboBoxFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComboBoxName2EditPart) {
			((ComboBoxName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureComboBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(ComboBoxName2EditPart.VISUAL_ID));
	}
	...
	public class ComboBoxFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureComboBoxLabelFigure;
		...
		private void createContents() {
			...
			fFigureComboBoxLabelFigure = new WrappingLabel();

			fFigureComboBoxLabelFigure.setText("ComboBox");

			this.add(fFigureComboBoxLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureComboBoxLabelFigure() {
			return fFigureComboBoxLabelFigure;
		}
