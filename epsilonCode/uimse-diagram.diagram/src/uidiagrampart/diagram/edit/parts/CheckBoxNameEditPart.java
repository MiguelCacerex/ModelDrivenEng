 ...
 * @generated
 */
public class CheckBoxNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UidiagrampartVisualIDRegistry.getType(uidiagrampart.diagram.edit.parts.CheckBoxNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CheckBoxNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.CheckBox_3005, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.CheckBoxNameEditPart.VISUAL_ID));
		}
		return parser;
	}
