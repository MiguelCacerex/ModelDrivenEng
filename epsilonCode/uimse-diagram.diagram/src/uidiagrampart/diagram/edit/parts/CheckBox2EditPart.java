...
import uidiagrampart.diagram.edit.policies.CheckBox2ItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class CheckBox2EditPart extends AbstractBorderedShapeEditPart {
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof CheckBoxName2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(CheckBoxName2EditPart.VISUAL_ID));
	}
