...
import uidiagrampart.diagram.edit.policies.TextFieldItemSemanticEditPolicy;
import uidiagrampart.diagram.part.UidiagrampartVisualIDRegistry;

/**
 * @generated
 */
public class TextFieldEditPart extends ShapeNodeEditPart {
...
protected void handleNotificationEvent(Notification arg0) {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextFieldNameEditPart) {
			((TextFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTextFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagrampartVisualIDRegistry.getType(TextFieldNameEditPart.VISUAL_ID));
	}
