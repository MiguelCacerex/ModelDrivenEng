 ...
 * @generated
 */
public class TextFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TextFieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.TextField_3009, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.TextFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
