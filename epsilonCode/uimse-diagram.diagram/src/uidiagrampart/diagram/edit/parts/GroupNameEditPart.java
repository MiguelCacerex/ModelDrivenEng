...
public class GroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.Group_3001, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.GroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
