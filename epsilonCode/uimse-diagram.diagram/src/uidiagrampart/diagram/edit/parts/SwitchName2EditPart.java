 ...
 * @generated
 */
public class SwitchName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UidiagrampartVisualIDRegistry.getType(uidiagrampart.diagram.edit.parts.SwitchName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SwitchName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagrampartParserProvider.getParser(UidiagrampartElementTypes.Switch_3015, getParserElement(),
					UidiagrampartVisualIDRegistry
							.getType(uidiagrampart.diagram.edit.parts.SwitchName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SwitchLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SwitchLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SwitchLabelFigure() {
			this.setText("Switch");
		}
