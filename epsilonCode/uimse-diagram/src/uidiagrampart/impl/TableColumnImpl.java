 ...
 * </p>
 * <ul>
 *   <li>{@link uidiagrampart.impl.TableColumnImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableColumnImpl extends PropertiesElementImpl implements TableColumn {
	/**
	...
	protected EClass eStaticClass() {
		return UidiagrampartPackage.Literals.TABLE_COLUMN;
	}
	...
	public void setUniqueID(String newUniqueID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagrampartPackage.TABLE_COLUMN__UNIQUE_ID, oldUniqueID, uniqueID));
	}
