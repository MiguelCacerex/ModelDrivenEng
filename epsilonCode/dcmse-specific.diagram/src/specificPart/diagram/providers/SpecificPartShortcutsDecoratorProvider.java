 ...
 * @generated
 */
public class SpecificPartShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = specificPart.diagram.part.SpecificPartDiagramEditorPlugin.getInstance()
