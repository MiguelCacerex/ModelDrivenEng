 ...
 * @generated
 */
public class SpecificPartValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = specificPart.diagram.part.SpecificPartDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof specificPart.diagram.part.SpecificPartDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && specificPart.diagram.edit.parts.ClassDiagramMSEEditPart.MODEL_ID
