 ...
 * @generated
 */
public class SpecificPartMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = specificPart.diagram.part.SpecificPartDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			specificPart.diagram.part.SpecificPartDiagramEditorUtil.selectElementsInDiagram(editor,
