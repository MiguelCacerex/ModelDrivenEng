 ...
 * @generated
 */
public class AgregationMSEMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AgregationMSEMultiplicityBEditPart.VISUAL_ID),
				new Point(-15, 12));
	}
	...
	* @generated
	*/
	public AgregationMSEMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEmultiplicityBLabelFigure();
	}

	/**
	* @generated
	*/
	public class AgregationMSEmultiplicityBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEmultiplicityBLabelFigure() {
