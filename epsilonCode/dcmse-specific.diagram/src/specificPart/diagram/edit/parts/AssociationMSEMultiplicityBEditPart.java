 ...
 * @generated
 */
public class AssociationMSEMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AssociationMSEMultiplicityBEditPart.VISUAL_ID),
				new Point(-15, 12));
	}
	...
	* @generated
	*/
	public AssociationMSEMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEmultiplicityBLabelFigure();
	}

	/**
	* @generated
	*/
	public class AssociationMSEmultiplicityBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEmultiplicityBLabelFigure() {
