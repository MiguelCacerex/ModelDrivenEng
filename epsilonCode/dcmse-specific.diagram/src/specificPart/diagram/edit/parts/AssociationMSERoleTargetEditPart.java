 ...
 * @generated
 */
public class AssociationMSERoleTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AssociationMSERoleTargetEditPart.VISUAL_ID), new Point(3, 12));
	}

	/**
	* @generated
	*/
	public AssociationMSERoleTargetEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.AssociationMSE_4003, getParserElement(),
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AssociationMSERoleTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEroleTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMSEroleTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEroleTargetLabelFigure() {
