 ...
 * @generated
 */
public class ImplementationMSEMultiplicityTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ImplementationMSEMultiplicityTargetEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public ImplementationMSEMultiplicityTargetEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.ImplementationMSEMultiplicityTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEmultiplicityTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImplementationMSEmultiplicityTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEmultiplicityTargetLabelFigure() {
			this.setText("multiplicityTarget");
		}
