 ...
 * @generated
 */
public class ContainmentMSEMultiplicityB2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ContainmentMSEMultiplicityB2EditPart.VISUAL_ID),
				new Point(-10, 10));
	}
	...
	* @generated
	*/
	public ContainmentMSEMultiplicityB2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSETargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentMSETargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSETargetLabelFigure() {
			this.setText("Target");
		}
