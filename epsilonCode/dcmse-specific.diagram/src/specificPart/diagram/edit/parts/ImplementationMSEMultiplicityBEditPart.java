 ...
 * @generated
 */
public class ImplementationMSEMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ImplementationMSEMultiplicityBEditPart.VISUAL_ID),
				new Point(-15, 12));
	}
	...
	* @generated
	*/
	public ImplementationMSEMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEmultiplicityBLabelFigure();
	}

	/**
	* @generated
	*/
	public class ImplementationMSEmultiplicityBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEmultiplicityBLabelFigure() {
			this.setText("multiplicityB");
		}
