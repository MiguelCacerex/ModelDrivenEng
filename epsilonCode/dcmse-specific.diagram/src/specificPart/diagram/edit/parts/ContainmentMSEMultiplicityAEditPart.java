 ...
 * @generated
 */
public class ContainmentMSEMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ContainmentMSEMultiplicityAEditPart.VISUAL_ID),
				new Point(15, -12));
	}
	...
	* @generated
	*/
	public ContainmentMSEMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEmultiplicityALabelFigure();
	}

	/**
	* @generated
	*/
	public class ContainmentMSEmultiplicityALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEmultiplicityALabelFigure() {
