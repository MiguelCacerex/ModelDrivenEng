 ...
 * @generated
 */
public class ContainmentMSEMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ContainmentMSEMultiplicityBEditPart.VISUAL_ID),
				new Point(-15, 12));
	}
	...
	* @generated
	*/
	public ContainmentMSEMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEmultiplicityBLabelFigure();
	}

	/**
	* @generated
	*/
	public class ContainmentMSEmultiplicityBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEmultiplicityBLabelFigure() {
