 ...
 * @generated
 */
public class AgregationMSEMultiplicitySourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AgregationMSEMultiplicitySourceEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AgregationMSEMultiplicitySourceEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.AgregationMSEMultiplicitySourceEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEmultiplicitySourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationMSEmultiplicitySourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEmultiplicitySourceLabelFigure() {
