 ...
 * @generated
 */
public class ContainmentMSEMultiplicityTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ContainmentMSEMultiplicityTargetEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public ContainmentMSEMultiplicityTargetEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.ContainmentMSEMultiplicityTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEmultiplicityTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentMSEmultiplicityTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEmultiplicityTargetLabelFigure() {
