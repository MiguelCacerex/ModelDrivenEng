 ...
 * @generated
 */
public class AssociationMSEMultiplicityTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AssociationMSEMultiplicityTargetEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AssociationMSEMultiplicityTargetEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.AssociationMSEMultiplicityTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEmultiplicityTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMSEmultiplicityTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEmultiplicityTargetLabelFigure() {
