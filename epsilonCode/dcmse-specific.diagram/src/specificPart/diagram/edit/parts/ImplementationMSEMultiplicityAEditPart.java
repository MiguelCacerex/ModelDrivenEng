 ...
 * @generated
 */
public class ImplementationMSEMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ImplementationMSEMultiplicityAEditPart.VISUAL_ID),
				new Point(15, -12));
	}
	...
	* @generated
	*/
	public ImplementationMSEMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEmultiplicityALabelFigure();
	}

	/**
	* @generated
	*/
	public class ImplementationMSEmultiplicityALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEmultiplicityALabelFigure() {
			this.setText("multiplicityA");
		}
