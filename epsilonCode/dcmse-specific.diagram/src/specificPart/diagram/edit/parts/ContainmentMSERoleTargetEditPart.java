 ...
 * @generated
 */
public class ContainmentMSERoleTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ContainmentMSERoleTargetEditPart.VISUAL_ID), new Point(3, 12));
	}

	/**
	* @generated
	*/
	public ContainmentMSERoleTargetEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new specificPart.diagram.edit.policies.SpecificPartTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.ContainmentMSE_4001, getParserElement(),
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.ContainmentMSERoleTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					specificPart.diagram.edit.parts.SpecificPartEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEroleTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentMSEroleTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEroleTargetLabelFigure() {
			this.setText("roleTarget");
		}
