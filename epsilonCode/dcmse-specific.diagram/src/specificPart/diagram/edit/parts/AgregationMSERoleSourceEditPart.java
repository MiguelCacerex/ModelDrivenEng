 ...
 * @generated
 */
public class AgregationMSERoleSourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AgregationMSERoleSourceEditPart.VISUAL_ID), new Point(0, 12));
	}

	/**
	* @generated
	*/
	public AgregationMSERoleSourceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEroleSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationMSEroleSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEroleSourceLabelFigure() {
