 ...
 * @generated
 */
public class ImplementationMSEMultiplicitySourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ImplementationMSEMultiplicitySourceEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public ImplementationMSEMultiplicitySourceEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.ImplementationMSE_4004, getParserElement(),
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.ImplementationMSEMultiplicitySourceEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEmultiplicitySourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImplementationMSEmultiplicitySourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEmultiplicitySourceLabelFigure() {
			this.setText("multiplicitySource");
		}
