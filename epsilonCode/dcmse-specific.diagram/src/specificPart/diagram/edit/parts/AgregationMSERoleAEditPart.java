 ...
 * @generated
 */
public class AgregationMSERoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AgregationMSERoleAEditPart.VISUAL_ID), new Point(-15, 12));
	}

	/**
	* @generated
	*/
	public AgregationMSERoleAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AgregationMSERoleAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEroleALabelFigure();
	}

	/**
	* @generated
	*/
	public class AgregationMSEroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEroleALabelFigure() {
			this.setText("roleA");
		}
