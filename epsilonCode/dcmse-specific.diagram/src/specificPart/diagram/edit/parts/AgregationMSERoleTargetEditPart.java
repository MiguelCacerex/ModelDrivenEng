 ...
 * @generated
 */
public class AgregationMSERoleTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AgregationMSERoleTargetEditPart.VISUAL_ID), new Point(3, 12));
	}

	/**
	* @generated
	*/
	public AgregationMSERoleTargetEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.AgregationMSE_4002, getParserElement(),
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AgregationMSERoleTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEroleTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationMSEroleTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEroleTargetLabelFigure() {
