 ...
 * @generated
 */
public class AssociationMSEMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AssociationMSEMultiplicityAEditPart.VISUAL_ID),
				new Point(15, -12));
	}
	...
	* @generated
	*/
	public AssociationMSEMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEmultiplicityALabelFigure();
	}

	/**
	* @generated
	*/
	public class AssociationMSEmultiplicityALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEmultiplicityALabelFigure() {
