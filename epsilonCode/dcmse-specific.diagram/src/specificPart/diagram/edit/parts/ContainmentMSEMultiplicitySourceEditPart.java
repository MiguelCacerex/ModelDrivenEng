 ...
 * @generated
 */
public class ContainmentMSEMultiplicitySourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ContainmentMSEMultiplicitySourceEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public ContainmentMSEMultiplicitySourceEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.ContainmentMSEMultiplicitySourceEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEmultiplicitySourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentMSEmultiplicitySourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEmultiplicitySourceLabelFigure() {
