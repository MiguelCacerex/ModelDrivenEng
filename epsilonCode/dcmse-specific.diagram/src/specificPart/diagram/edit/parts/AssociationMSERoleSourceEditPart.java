 ...
 * @generated
 */
public class AssociationMSERoleSourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AssociationMSERoleSourceEditPart.VISUAL_ID), new Point(0, 12));
	}

	/**
	* @generated
	*/
	public AssociationMSERoleSourceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEroleSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMSEroleSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEroleSourceLabelFigure() {
