 ...
 * @generated
 */
public class AssociationMSERoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AssociationMSERoleAEditPart.VISUAL_ID), new Point(-15, 12));
	}

	/**
	* @generated
	*/
	public AssociationMSERoleAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AssociationMSERoleAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEroleALabelFigure();
	}

	/**
	* @generated
	*/
	public class AssociationMSEroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEroleALabelFigure() {
			this.setText("roleA");
		}
