 ...
 * @generated
 */
public class AgregationMSEMultiplicityB2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AgregationMSEMultiplicityB2EditPart.VISUAL_ID),
				new Point(-10, 10));
	}
	...
	* @generated
	*/
	public AgregationMSEMultiplicityB2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSETargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationMSETargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSETargetLabelFigure() {
			this.setText("Target");
		}
