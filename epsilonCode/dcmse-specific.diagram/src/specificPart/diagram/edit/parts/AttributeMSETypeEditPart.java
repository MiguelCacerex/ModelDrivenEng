 ...
 * @generated
 */
public class AttributeMSETypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeMSETypeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return specificPart.diagram.providers.SpecificPartElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.AttributeMSE_3001, getParserElement(),
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AttributeMSETypeEditPart.VISUAL_ID));
		}
		return parser;
	}
