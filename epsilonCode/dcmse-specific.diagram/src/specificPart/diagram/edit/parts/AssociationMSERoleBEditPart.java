 ...
 * @generated
 */
public class AssociationMSERoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AssociationMSERoleBEditPart.VISUAL_ID), new Point(15, -12));
	}

	/**
	* @generated
	*/
	public AssociationMSERoleBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AssociationMSERoleBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEroleBLabelFigure();
	}

	/**
	* @generated
	*/
	public class AssociationMSEroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEroleBLabelFigure() {
			this.setText("roleB");
		}
