 ...
 * @generated
 */
public class ImplementationMSEMultiplicityB2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.ImplementationMSEMultiplicityB2EditPart.VISUAL_ID),
				new Point(-50, 5));
	}
	...
	* @generated
	*/
	public ImplementationMSEMultiplicityB2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.ImplementationMSEMultiplicityB2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSETargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImplementationMSETargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSETargetLabelFigure() {
			this.setText("Target");
		}
