 ...
 * @generated
 */
public class MethodMSENameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodMSENameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					specificPart.diagram.providers.SpecificPartElementTypes.MethodMSE_3002, getParserElement(),
