 ...
 * @generated
 */
public class ImplementationMSERoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ImplementationMSERoleBEditPart.VISUAL_ID), new Point(15, -12));
	}

	/**
	* @generated
	*/
	public ImplementationMSERoleBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.ImplementationMSERoleBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEroleBLabelFigure();
	}

	/**
	* @generated
	*/
	public class ImplementationMSEroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEroleBLabelFigure() {
			this.setText("roleB");
		}
