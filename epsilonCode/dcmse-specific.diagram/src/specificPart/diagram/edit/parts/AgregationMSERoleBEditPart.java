 ...
 * @generated
 */
public class AgregationMSERoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.AgregationMSERoleBEditPart.VISUAL_ID), new Point(15, -12));
	}

	/**
	* @generated
	*/
	public AgregationMSERoleBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.AgregationMSERoleBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEroleBLabelFigure();
	}

	/**
	* @generated
	*/
	public class AgregationMSEroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEroleBLabelFigure() {
			this.setText("roleB");
		}
