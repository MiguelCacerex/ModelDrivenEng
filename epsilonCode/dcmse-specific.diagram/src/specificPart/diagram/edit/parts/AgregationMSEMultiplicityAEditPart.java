 ...
 * @generated
 */
public class AgregationMSEMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AgregationMSEMultiplicityAEditPart.VISUAL_ID),
				new Point(15, -12));
	}
	...
	* @generated
	*/
	public AgregationMSEMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEmultiplicityALabelFigure();
	}

	/**
	* @generated
	*/
	public class AgregationMSEmultiplicityALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEmultiplicityALabelFigure() {
