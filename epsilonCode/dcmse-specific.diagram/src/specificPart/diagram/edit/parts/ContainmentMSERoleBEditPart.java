 ...
 * @generated
 */
public class ContainmentMSERoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ContainmentMSERoleBEditPart.VISUAL_ID), new Point(15, -12));
	}

	/**
	* @generated
	*/
	public ContainmentMSERoleBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.ContainmentMSERoleBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEroleBLabelFigure();
	}

	/**
	* @generated
	*/
	public class ContainmentMSEroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEroleBLabelFigure() {
			this.setText("roleB");
		}
