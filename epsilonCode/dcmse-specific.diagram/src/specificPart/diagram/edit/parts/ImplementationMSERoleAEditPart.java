 ...
 * @generated
 */
public class ImplementationMSERoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ImplementationMSERoleAEditPart.VISUAL_ID), new Point(-15, 12));
	}

	/**
	* @generated
	*/
	public ImplementationMSERoleAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.ImplementationMSERoleAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementationMSEroleALabelFigure();
	}

	/**
	* @generated
	*/
	public class ImplementationMSEroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementationMSEroleALabelFigure() {
			this.setText("roleA");
		}
