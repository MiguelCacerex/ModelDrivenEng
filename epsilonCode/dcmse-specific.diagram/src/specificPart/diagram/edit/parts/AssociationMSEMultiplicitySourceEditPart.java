 ...
 * @generated
 */
public class AssociationMSEMultiplicitySourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AssociationMSEMultiplicitySourceEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AssociationMSEMultiplicitySourceEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.AssociationMSEMultiplicitySourceEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSEmultiplicitySourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMSEmultiplicitySourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSEmultiplicitySourceLabelFigure() {
