 ...
 * @generated
 */
public class ClassDiagramMSEEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "SpecificPart"; //$NON-NLS-1$
	...
	* @generated
	*/
	public ClassDiagramMSEEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new specificPart.diagram.edit.policies.ClassDiagramMSEItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new specificPart.diagram.edit.policies.ClassDiagramMSECanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new specificPart.diagram.edit.commands.SpecificPartCreateShortcutDecorationsCommand(
