 ...
 * @generated
 */
public class AgregationMSEMultiplicityTargetEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AgregationMSEMultiplicityTargetEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AgregationMSEMultiplicityTargetEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry.getType(
							specificPart.diagram.edit.parts.AgregationMSEMultiplicityTargetEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationMSEmultiplicityTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationMSEmultiplicityTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationMSEmultiplicityTargetLabelFigure() {
