 ...
 * @generated
 */
public class ContainmentMSERoleSourceEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ContainmentMSERoleSourceEditPart.VISUAL_ID), new Point(0, 12));
	}

	/**
	* @generated
	*/
	public ContainmentMSERoleSourceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEroleSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentMSEroleSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEroleSourceLabelFigure() {
			this.setText("roleSource");
		}
