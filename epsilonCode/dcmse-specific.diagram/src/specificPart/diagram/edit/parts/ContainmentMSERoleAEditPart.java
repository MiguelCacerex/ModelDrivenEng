 ...
 * @generated
 */
public class ContainmentMSERoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(specificPart.diagram.part.SpecificPartVisualIDRegistry
				.getType(specificPart.diagram.edit.parts.ContainmentMSERoleAEditPart.VISUAL_ID), new Point(-15, 12));
	}

	/**
	* @generated
	*/
	public ContainmentMSERoleAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = specificPart.diagram.providers.SpecificPartParserProvider.getParser(
					...
					specificPart.diagram.part.SpecificPartVisualIDRegistry
							.getType(specificPart.diagram.edit.parts.ContainmentMSERoleAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentMSEroleALabelFigure();
	}

	/**
	* @generated
	*/
	public class ContainmentMSEroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentMSEroleALabelFigure() {
			this.setText("roleA");
		}
