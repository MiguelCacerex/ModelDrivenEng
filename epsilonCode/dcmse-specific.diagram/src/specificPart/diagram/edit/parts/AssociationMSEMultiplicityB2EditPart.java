 ...
 * @generated
 */
public class AssociationMSEMultiplicityB2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				specificPart.diagram.part.SpecificPartVisualIDRegistry
						.getType(specificPart.diagram.edit.parts.AssociationMSEMultiplicityB2EditPart.VISUAL_ID),
				new Point(-10, 10));
	}
	...
	* @generated
	*/
	public AssociationMSEMultiplicityB2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationMSETargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationMSETargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationMSETargetLabelFigure() {
			this.setText("Target");
		}
