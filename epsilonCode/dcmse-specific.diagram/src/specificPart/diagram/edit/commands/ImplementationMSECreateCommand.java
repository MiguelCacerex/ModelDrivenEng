 ...
 * @generated
 */
public class ImplementationMSECreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImplementationMSECreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateImplementationMSE_4004(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		specificPart.ImplementationMSE newElement = specificPart.SpecificPartFactory.eINSTANCE
				.createImplementationMSE();
		getContainer().getLstRelations().add(newElement);
		newElement.setSource(getSource());
		newElement.setTarget(getTarget());
		newElement.setMultiplicitySource("*");
		newElement.setType("implementation");
		newElement.setRoleSource("lst"+getSource().getName());
		newElement.setMultiplicityTarget("1");
		newElement.setDocumentation("Esta es la relacion de implementacion que sale desde "+getSource()+" hacia "+getTarget());
		newElement.setRoleTarget("impl"+getSource().getName());
	...
	* @generated
	*/
	protected void doConfigure(specificPart.ImplementationMSE newElement, IProgressMonitor monitor, IAdaptable info)
