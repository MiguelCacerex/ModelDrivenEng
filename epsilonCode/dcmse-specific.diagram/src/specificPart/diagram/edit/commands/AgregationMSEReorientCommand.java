 ...
 * @generated
 */
public class AgregationMSEReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AgregationMSEReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof specificPart.AgregationMSE) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgregationMSE_4002(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		specificPart.ClassDiagramMSE container = (specificPart.ClassDiagramMSE) getLink().eContainer();
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgregationMSE_4002(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected specificPart.AgregationMSE getLink() {
		return (specificPart.AgregationMSE) getElementToEdit();
	}
