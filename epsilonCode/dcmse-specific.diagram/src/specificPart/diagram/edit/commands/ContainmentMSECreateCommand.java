 ...
 * @generated
 */
public class ContainmentMSECreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ContainmentMSECreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateContainmentMSE_4001(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		specificPart.ContainmentMSE newElement = specificPart.SpecificPartFactory.eINSTANCE.createContainmentMSE();
		...
		newElement.setType("containment");
		newElement.setMultiplicityTarget("1");
		newElement.setRoleTarget("ownedBy"+getTarget().getName());
		newElement.setDocumentation("Esta es la relacion de contencion que sale desde "+getSource()+" hacia "+getTarget());
	...
	* @generated
	*/
	protected void doConfigure(specificPart.ContainmentMSE newElement, IProgressMonitor monitor, IAdaptable info)
