 ...
 * @generated
 */
public class AgregationMSECreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AgregationMSECreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateAgregationMSE_4002(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		specificPart.AgregationMSE newElement = specificPart.SpecificPartFactory.eINSTANCE.createAgregationMSE();
		...
		newElement.setType("agregation");
		newElement.setRoleTarget("the"+getTarget().getName());
		newElement.setDocumentation("Esta es la relacion de agregacion que sale desde "+getSource()+" hacia "+getTarget());
	...
	* @generated
	*/
	protected void doConfigure(specificPart.AgregationMSE newElement, IProgressMonitor monitor, IAdaptable info)
