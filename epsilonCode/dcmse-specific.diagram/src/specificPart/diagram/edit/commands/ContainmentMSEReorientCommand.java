 ...
 * @generated
 */
public class ContainmentMSEReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ContainmentMSEReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof specificPart.ContainmentMSE) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContainmentMSE_4001(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		specificPart.ClassDiagramMSE container = (specificPart.ClassDiagramMSE) getLink().eContainer();
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContainmentMSE_4001(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected specificPart.ContainmentMSE getLink() {
		return (specificPart.ContainmentMSE) getElementToEdit();
	}
