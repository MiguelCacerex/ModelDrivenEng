 ...
 * @generated
 */
public class InheritanceMSECreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InheritanceMSECreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInheritanceMSE_4005(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		specificPart.InheritanceMSE newElement = specificPart.SpecificPartFactory.eINSTANCE.createInheritanceMSE();
		getContainer().getLstInheritances().add(newElement);
	...
	* @generated
	*/
	protected void doConfigure(specificPart.InheritanceMSE newElement, IProgressMonitor monitor, IAdaptable info)
