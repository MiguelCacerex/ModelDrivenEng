 ...
 * @generated
 */
public class ImplementationMSEReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImplementationMSEReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof specificPart.ImplementationMSE) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistImplementationMSE_4004(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		specificPart.ClassDiagramMSE container = (specificPart.ClassDiagramMSE) getLink().eContainer();
		return specificPart.diagram.edit.policies.SpecificPartBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistImplementationMSE_4004(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected specificPart.ImplementationMSE getLink() {
		return (specificPart.ImplementationMSE) getElementToEdit();
	}
