 ...
 * 
 */
package specificPart.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(specificPart.diagram.part.SpecificPartDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(specificPart.diagram.part.Messages.MessageFormatParser_InvalidInputError,
