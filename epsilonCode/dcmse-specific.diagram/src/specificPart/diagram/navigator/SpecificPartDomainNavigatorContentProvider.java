 ...
 * @generated
 */
public class SpecificPartDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public SpecificPartDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof specificPart.diagram.navigator.SpecificPartDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((specificPart.diagram.navigator.SpecificPartDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new specificPart.diagram.navigator.SpecificPartDomainNavigatorItem((EObject) objects[i],
